...
def preprocess_raw_lookit_dataset(force_create=False):
    ...
    logging.info('[preprocess_raw] coding_fist: {}'.format(len(coding_first)))
...
def process_lookit_dataset_legacy(force_create=False):
    """
    TODO: huge bug with this - frames which don't have an associated extracted patch are labeled as -1 !!!
